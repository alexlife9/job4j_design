...
class SimpleCollectionTest {
     ...
     * как можно выбрать из коллекции группу элементов по некоторому условию и дальше работать с отобранной группой:
     */
    @Test
    ...
    /**
     * Также библиотека AssertJ может работать с коллекциями, реализующими интерфейс java.util.Map
     */
    @Test
    void assertMap() {
